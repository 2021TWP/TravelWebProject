...
urlpatterns = [
    ...
    path('group/<int:g_id>/schedule/update/<int:pk>', views.schedule_content_update, name="group_schedule_list"),
    path('group/<int:g_id>/schedule/delete/<int:pk>', views.schedule_content_delete, name="group_schedule_list"),
